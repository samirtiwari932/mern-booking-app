...
const SearchBar = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='-mt-8 p-3 bg-orange-400 rounded shadow-sm grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4 ' >
            ...
            <div className='flex gap-1'>
                <button className='w-2/3 bg-blue-600 text-white h-full p-2 foont-bold text-xl hover:bg-blue-500 '>
                    Search
                </button>
                <button className='w-1/3 bg-red-600 text-white h-full p-2 foont-bold text-xl hover:bg-red-500 '>
                    Clear
                </button>
            </div>
        </form>
